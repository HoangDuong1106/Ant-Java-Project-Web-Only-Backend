            ...
            if (session != null) {
                ...
                if (cart != null) {
                    ...
                    if (items != null) {
                        ...
                        if (list != null) {
                            List<String> listSkuNeedDelete = Arrays.asList(list);
                            listSkuNeedDelete.stream().forEach(sku -> cart.deleteItemInCart(sku));
                            if (cart.getItems() != null) {
                                session.setAttribute(Constraint.CART_ATTRIBUTE_NAME, cart);
                            } else {
                                session.removeAttribute(Constraint.CART_ATTRIBUTE_NAME);
                            }
                        }
                    }
                }
