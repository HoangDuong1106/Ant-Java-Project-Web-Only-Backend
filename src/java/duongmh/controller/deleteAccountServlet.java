...
public class deleteAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // parameter
        String usernameNeedDelete = request.getParameter("username");
        ...
        try {
            if (request.getSession(false) != null) {
                ...
                boolean result = dao.deleteAccountByUsername(usernameNeedDelete);
...
//                context.log("");
            ...
            response.sendRedirect(url + "?txtSearchValue=" + lastSearchValue);
        }
    }
