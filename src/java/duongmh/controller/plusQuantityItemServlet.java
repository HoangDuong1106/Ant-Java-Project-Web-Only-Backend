 ...
 * @author admin
 */
@WebServlet(name = "plusQuantityItemServlet", urlPatterns = {"/plusQuantityItemServlet"})
public class plusQuantityItemServlet extends HttpServlet {
        ...
        try {
            ...
            if (session != null) {
                ...
                if (cart != null) {
                    ...
                    if (items != null) {
                        String sku = request.getParameter("skuPlus");
                        cart.plusQuantityItem(sku);
